      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Experience straightforward and honest pricing with no hidden fees. Our plans are designed to provide the best value for your interview preparation, ensuring you get the support you need without any surprises.
          </p>
        </div>
